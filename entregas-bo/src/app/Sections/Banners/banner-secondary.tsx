...
const HeroBannerSecondary: React.FC = () => {
  return (
    <div className="container mx-auto my-10 w-[90%] md:w-[95%] px-6 md:px-8 py-10 relative flex flex-col md:flex-row items-center justify-between bg-gradient-to-r from-[#FCCF42] to-[#007D3D] text-white rounded-lg overflow-hidden min-h-[400px]">
      {/* Contenido de Texto */}
